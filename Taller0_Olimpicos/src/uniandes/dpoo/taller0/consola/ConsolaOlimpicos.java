...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. - Nombre del pais que representa al altleta - ");
	 ...
	 * consola.
	 */
	private void ejecutarCargarNombrePais()
	{
		String atletaNombre = input("\n" + "Ingrese el nombre del atleta:" + "\n");
		String atletaPais = calculadora.infoPaisAtleta(atletaNombre);
		System.out.println("Se encontro que el pais al cual pertenece el atleta es el siguiente:"+ atletaPais);
